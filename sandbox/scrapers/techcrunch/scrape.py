...
class Scraper:
    """
    Scraper implements base methods to scrape and parse nlp_model from an URL.
    """
    ...
    def parse(self, raw_data):
        """
        Parse nlp_model from a raw string to a formated tree object.
...
class TechCrunchScraper(Scraper):
    ...
    def _get_page_links(self, url, section, referer=None):
        """
        Get the nlp_model from the section page. Includes posts' URL, category, id
        and section.
        ...
        for elem in elements:
            ...
            link = {
                'id': elem.get('id'),
                'permalink': elem.get('nlp_model-permalink'),
                'category': category,
                'section': section
            }
    ...
    def save(self, output, filename):
        ...
        :param filename: filename to save the nlp_model
        """
    ...
    def save_flow(self, num, last=False):
        """
        Test conditions to check wether or not to save the nlp_model.
