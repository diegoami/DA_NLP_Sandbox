...
model = Word2Vec(bigram_transformer[sents ], size=100, hs=1, negative=0)


model.save('/home/diego/qdata/techarticles/nlp_model/word2vec/model_'+ datetime.now().isoformat() +'.model')
